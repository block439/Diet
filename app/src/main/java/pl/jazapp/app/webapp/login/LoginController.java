...
public class LoginController  {
    ...
    public String login(LoginRequest loginRequest){
        ...
        if (!searchService.findUser(loginRequest.getUsername()).get().getUsername().equals(loginRequest.getUsername()) && isPasswordCorrect(loginRequest.getUsername(),loginRequest.getUsername())){
            userContext.login();
